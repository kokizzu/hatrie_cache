...
| CH-037 | `ARRAY JOIN` | Partially adopted for direct row-source arrays and `LEFT ARRAY JOIN`, with deterministic expansion, empty/NULL-array preservation, scalar rejection, row/work limits, and `EXPLAIN` output; richer nested-array traversal and physical nested-column execution remain open. See [CH037_LEFT_ARRAY_JOIN.md](CH037_LEFT_ARRAY_JOIN.md). | Medium |
