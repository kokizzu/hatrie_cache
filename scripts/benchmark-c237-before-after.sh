...
printf '%s\n' 'C237 current benchmark:'
GOMAXPROCS=1 go test ./hat/hatSql -run '^$' -bench '^BenchmarkC237ExplainProjectionSelection$' -benchmem -benchtime=2s -count=5
