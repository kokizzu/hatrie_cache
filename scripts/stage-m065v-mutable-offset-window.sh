...
git add -- \
  ...
  scripts/review-m065v-mutable-offset-window.sh \
  scripts/stage-m065v-mutable-offset-window.sh \
  scripts/commit-m065v-mutable-offset-window.sh \
  scripts/push-m065v-mutable-offset-window.sh \
