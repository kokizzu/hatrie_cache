...
printf '===== M052t documentation =====\n'
rg -n 'M052t|SQL_AUTO_NATIVE_GROUPED_ORDERED' \
  INSPIRATION.md ADOPTED_QUERY_ENGINE_IDEAS.md BENCHMARK.md SQL_AUTO_NATIVE_GROUPED_ORDERED.md
printf '===== M052v documentation =====\n'
rg -n 'M052v|SQL_AUTO_NATIVE_SCALAR_LIMIT' \
  INSPIRATION.md ADOPTED_QUERY_ENGINE_IDEAS.md BENCHMARK.md SQL_AUTO_NATIVE_SCALAR_LIMIT.md
printf '===== M052w documentation =====\n'
rg -n 'M052w|SQL_AUTO_NATIVE_DISTINCT_LIMIT' \
  INSPIRATION.md ADOPTED_QUERY_ENGINE_IDEAS.md BENCHMARK.md SQL_AUTO_NATIVE_DISTINCT_LIMIT.md
printf '===== M052x documentation =====\n'
rg -n 'M052x|SQL_AUTO_NATIVE_AGGREGATE_LIMIT' \
  INSPIRATION.md ADOPTED_QUERY_ENGINE_IDEAS.md BENCHMARK.md SQL_AUTO_NATIVE_AGGREGATE_LIMIT.md
printf '%s\n' '===== M052y documentation ====='
rg -n -A 8 'M052y|SQL_AUTO_NATIVE_COMPOSITE_GROUPED_ORDERED' \
  SQL_AUTO_NATIVE_COMPOSITE_GROUPED_ORDERED.md INSPIRATION.md ADOPTED_QUERY_ENGINE_IDEAS.md BENCHMARK.md
