...
run_memory_sample "materialized baseline" '^BenchmarkCHU04ExternalDistinctBaselineAndStreaming/materialized_baseline$'
run_memory_sample "streaming external spill" '^BenchmarkCHU04ExternalDistinctBaselineAndStreaming/streaming_external_spill$'
