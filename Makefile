...
bench-ci-smoke:
	BENCH_CI_SMOKE_BENCHTIME='$(BENCH_CI_SMOKE_BENCHTIME)' BENCH_CI_SMOKE_COUNT='$(BENCH_CI_SMOKE_COUNT)' BENCH_CI_SMOKE_COMMAND_BENCH='$(BENCH_CI_SMOKE_COMMAND_BENCH)' BENCH_CI_SMOKE_TRANSPORT_BENCH='$(BENCH_CI_SMOKE_TRANSPORT_BENCH)' BENCH_CI_SMOKE_SERIALIZATION_BENCH='$(BENCH_CI_SMOKE_SERIALIZATION_BENCH)' BENCH_CI_SMOKE_CHECK_THRESHOLDS='$(BENCH_CI_SMOKE_CHECK_THRESHOLDS)' BENCH_CI_SMOKE_MAX_COMMAND_NS_OP='$(BENCH_CI_SMOKE_MAX_COMMAND_NS_OP)' BENCH_CI_SMOKE_MAX_TRANSPORT_NS_OP='$(BENCH_CI_SMOKE_MAX_TRANSPORT_NS_OP)' BENCH_CI_SMOKE_MAX_SERIALIZATION_NS_OP='$(BENCH_CI_SMOKE_MAX_SERIALIZATION_NS_OP)' BENCH_CI_SMOKE_MAX_B_OP='$(BENCH_CI_SMOKE_MAX_B_OP)' BENCH_CI_SMOKE_MAX_ALLOCS_OP='$(BENCH_CI_SMOKE_MAX_ALLOCS_OP)' ./scripts/benchmark-ci-smoke.sh
