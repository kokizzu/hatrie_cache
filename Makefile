...
.PHONY: test-ch007-red
test-ch007-red:
	bash ./scripts/test-ch007.sh red

.PHONY: benchmark-ch007-baseline
benchmark-ch007-baseline:
	bash ./scripts/test-ch007.sh baseline

.PHONY: test-ch007-package
test-ch007-package:
	bash ./scripts/test-ch007.sh package

.PHONY: race-ch007
race-ch007:
	bash ./scripts/test-ch007.sh race

.PHONY: vet-ch007
vet-ch007:
	bash ./scripts/test-ch007.sh vet

.PHONY: format-ch007
format-ch007:
	bash ./scripts/test-ch007.sh format

.PHONY: check-ch007
check-ch007:
	bash ./scripts/test-ch007.sh check

.PHONY: benchmark-ch007
benchmark-ch007:
	bash ./scripts/test-ch007.sh benchmark

.PHONY: status-ch007
status-ch007:
	bash ./scripts/status-ch007.sh

.PHONY: commit-ch007
commit-ch007:
	bash ./scripts/commit-ch007.sh
...
test-mz008:
	bash ./scripts/test-mz008.sh

format-mz008:
	bash ./scripts/format-mz008.sh

test-mz008-race:
	bash ./scripts/test-mz008-race.sh

test-mz008-full:
	bash ./scripts/test-mz008-full.sh

benchmark-mz008:
	bash ./scripts/benchmark-mz008.sh

status-mz008:
	bash ./scripts/status-mz008.sh

commit-mz008:
	bash ./scripts/commit-mz008.sh
...
.PHONY: test-tr004-replication-key-filter
test-tr004-replication-key-filter:
	bash ./scripts/test-tr004-replication-key-filter.sh

.PHONY: format-tr004-replication-key-filter
format-tr004-replication-key-filter:
	bash ./scripts/format-tr004-replication-key-filter.sh

.PHONY: benchmark-tr004-replication-key-filter
benchmark-tr004-replication-key-filter:
	bash ./scripts/benchmark-tr004-replication-key-filter.sh

.PHONY: race-tr004-replication-key-filter
race-tr004-replication-key-filter:
	bash ./scripts/race-tr004-replication-key-filter.sh

.PHONY: vet-tr004-replication-key-filter
vet-tr004-replication-key-filter:
	bash ./scripts/vet-tr004-replication-key-filter.sh

.PHONY: review-tr004-replication-key-filter
review-tr004-replication-key-filter:
	bash ./scripts/review-tr004-replication-key-filter.sh

.PHONY: commit-tr004-replication-key-filter
commit-tr004-replication-key-filter:
	bash ./scripts/commit-tr004-replication-key-filter.sh
...
.PHONY: test-tr048-audit-sampling
test-tr048-audit-sampling:
	bash ./scripts/test-tr048-audit-sampling.sh
.PHONY: format-tr048-audit-sampling
format-tr048-audit-sampling:
	bash ./scripts/format-tr048-audit-sampling.sh
.PHONY: benchmark-tr048-audit-sampling
benchmark-tr048-audit-sampling:
	bash ./scripts/benchmark-tr048-audit-sampling.sh
.PHONY: race-tr048-audit-sampling
race-tr048-audit-sampling:
	bash ./scripts/race-tr048-audit-sampling.sh

.PHONY: vet-tr048-audit-sampling
vet-tr048-audit-sampling:
	bash ./scripts/vet-tr048-audit-sampling.sh

.PHONY: review-tr048-audit-sampling
review-tr048-audit-sampling:
	bash ./scripts/review-tr048-audit-sampling.sh

.PHONY: commit-tr048-audit-sampling
commit-tr048-audit-sampling:
	bash ./scripts/commit-tr048-audit-sampling.sh
...
.PHONY: format-chu28 test-chu28 test-chu28-package benchmark-chu28 race-chu28 vet-chu28 commit-chu28
format-chu28:
	bash ./scripts/format-chu28.sh

test-chu28:
	bash ./scripts/test-chu28.sh

test-chu28-package:
	bash ./scripts/test-chu28-package.sh

benchmark-chu28:
	bash ./scripts/benchmark-chu28.sh

race-chu28:
	bash ./scripts/race-chu28.sh

vet-chu28:
	bash ./scripts/vet-chu28.sh
...
.PHONY: format-m090a test-m090a race-m090a vet-m090a benchmark-m090a verify-m090a
format-m090a:
	@bash scripts/format-m090a.sh

test-m090a:
	@bash scripts/test-m090a.sh

race-m090a:
	@bash scripts/race-m090a.sh

vet-m090a:
	@bash scripts/vet-m090a.sh

benchmark-m090a:
	@bash scripts/benchmark-m090a.sh
...
test-mu37:
	bash scripts/test-mu37.sh

benchmark-mu37-baseline:
	bash scripts/benchmark-mu37-baseline.sh

benchmark-mu37:
	bash scripts/benchmark-mu37.sh

format-mu37:
	bash scripts/format-mu37.sh
...
benchmark-mu45-baseline:
	@bash scripts/benchmark-mu45-baseline.sh
...
.PHONY: test-tu32
test-tu32:
	bash scripts/test-tu32.sh

.PHONY: format-tu32
format-tu32:
	bash scripts/format-tu32.sh

.PHONY: race-tu32
race-tu32:
	bash scripts/race-tu32.sh

.PHONY: vet-tu32
vet-tu32:
	bash scripts/vet-tu32.sh

.PHONY: benchmark-tu32
benchmark-tu32:
	bash scripts/benchmark-tu32.sh

.PHONY: review-tu32
review-tu32:
	bash scripts/review-tu32.sh

.PHONY: stage-tu32
stage-tu32:
	bash scripts/stage-tu32.sh

.PHONY: commit-tu32
commit-tu32:
	bash scripts/commit-tu32.sh

.PHONY: push-tu32
push-tu32:
	bash scripts/push-tu32.sh
...
m209-format:
	bash scripts/m209-format.sh

m209-test:
	bash scripts/m209-test.sh

m209-race:
	bash scripts/m209-race.sh

m209-vet:
	bash scripts/m209-vet.sh

m209-benchmark:
	bash scripts/m209-benchmark.sh

m209-stage:
	bash scripts/m209-stage.sh

m209-commit:
	bash scripts/m209-commit.sh
...
m211-format:
	bash scripts/m211-format.sh

m211-test:
	bash scripts/m211-test.sh

m211-race:
	bash scripts/m211-race.sh

m211-vet:
	bash scripts/m211-vet.sh

m211-benchmark:
	bash scripts/m211-benchmark.sh

m211-stage:
	bash scripts/m211-stage.sh

m211-commit:
	bash scripts/m211-commit.sh

m211-push:
	bash scripts/m211-push.sh

m212-format:
	bash scripts/m212-format.sh

m212-test:
	bash scripts/m212-test.sh

m212-race:
	bash scripts/m212-race.sh

m212-vet:
	bash scripts/m212-vet.sh

m212-benchmark:
	bash scripts/m212-benchmark.sh
...
.PHONY: stage-c226-ledger-reconciliation commit-c226-ledger-reconciliation push-c226-ledger-reconciliation
stage-c226-ledger-reconciliation:
	bash ./scripts/stage-c226-ledger-reconciliation.sh

commit-c226-ledger-reconciliation:
	bash ./scripts/commit-c226-ledger-reconciliation.sh

push-c226-ledger-reconciliation:
	bash ./scripts/push-c226-ledger-reconciliation.sh

.PHONY: stage-c228-ledger-reconciliation commit-c228-ledger-reconciliation push-c228-ledger-reconciliation
stage-c228-ledger-reconciliation:
	bash ./scripts/stage-c228-ledger-reconciliation.sh

commit-c228-ledger-reconciliation:
	bash ./scripts/commit-c228-ledger-reconciliation.sh
...
.PHONY: test-t206 test-t206-package race-t206 vet-t206 benchmark-t206-before
test-t206:
...
benchmark-t206-before:
	@bash scripts/benchmark-t206-before.sh

.PHONY: format-t206 benchmark-t206 stage-t206 commit-t206 push-t206
format-t206:
...
.PHONY: test-t210 test-t210-package benchmark-t210-before format-t210 benchmark-t210 race-t210 vet-t210
test-t210:
	@bash scripts/test-t210.sh
test-t210-package:
	@bash scripts/test-t210-package.sh
benchmark-t210-before:
	@bash scripts/benchmark-t210-before.sh
format-t210:
...
.PHONY: benchmark-t217-before
benchmark-t217-before:
	bash scripts/benchmark-t217-before.sh

.PHONY: benchmark-t217
benchmark-t217:
	bash scripts/benchmark-t217.sh

.PHONY: test-t217-package
test-t217-package:
	bash scripts/test-t217-package.sh
...
.PHONY: verify-t217-scope
verify-t217-scope:
	bash scripts/verify-t217-scope.sh
...
.PHONY: format-t218
format-t218:
	bash scripts/format-t218.sh

.PHONY: test-t218
test-t218:
	bash scripts/test-t218.sh

.PHONY: benchmark-t218-before
benchmark-t218-before:
	bash scripts/benchmark-t218-before.sh

.PHONY: benchmark-t218
benchmark-t218:
	bash scripts/benchmark-t218.sh

.PHONY: test-t218-package
test-t218-package:
	bash scripts/test-t218-package.sh

.PHONY: race-t218
race-t218:
	bash scripts/race-t218.sh

.PHONY: vet-t218
vet-t218:
	bash scripts/vet-t218.sh

.PHONY: verify-t218-scope
verify-t218-scope:
	bash scripts/verify-t218-scope.sh

.PHONY: stage-t218
stage-t218:
	bash scripts/stage-t218.sh

.PHONY: commit-t218
commit-t218:
	bash scripts/commit-t218.sh
...
.PHONY: format-t220
format-t220:
	bash scripts/format-t220.sh

.PHONY: test-t220
test-t220:
	bash scripts/test-t220.sh

.PHONY: benchmark-t220
benchmark-t220:
	bash scripts/benchmark-t220.sh

.PHONY: race-t220
race-t220:
	bash scripts/race-t220.sh

.PHONY: vet-t220
vet-t220:
	bash scripts/vet-t220.sh

.PHONY: verify-t220-scope
verify-t220-scope:
	bash scripts/verify-t220-scope.sh

.PHONY: stage-t220
stage-t220:
	bash scripts/stage-t220.sh

.PHONY: commit-t220
commit-t220:
	bash scripts/commit-t220.sh
...
benchmark-t224:
	bash ./scripts/benchmark-t224.sh

race-t224:
	bash ./scripts/race-t224.sh

vet-t224:
	bash ./scripts/vet-t224.sh

verify-t224-scope:
	bash ./scripts/verify-t224-scope.sh

stage-t224:
	bash ./scripts/stage-t224.sh

commit-t224:
	bash ./scripts/commit-t224.sh

push-t224:
	bash ./scripts/push-t224.sh
...
.PHONY: benchmark-t233-before
benchmark-t233-before:
	bash scripts/benchmark-t233-before.sh
...
m212-stage:
	bash scripts/m212-stage.sh

m212-commit:
	bash scripts/m212-commit.sh
...
m215-test:
	bash scripts/m215-test.sh

m215-benchmark:
	bash scripts/m215-benchmark.sh

m215-format:
	bash scripts/m215-format.sh

m215-race:
	bash scripts/m215-race.sh

m215-vet:
	bash scripts/m215-vet.sh

m215-stage:
	bash scripts/m215-stage.sh

m215-commit:
	bash scripts/m215-commit.sh
...
m218-test:
	bash scripts/m218-test.sh

m218-benchmark:
	bash scripts/m218-benchmark.sh

m218-format:
	bash scripts/m218-format.sh

m218-race:
	bash scripts/m218-race.sh

m218-vet:
	bash scripts/m218-vet.sh

m218-stage:
	bash scripts/m218-stage.sh

m218-commit:
	bash scripts/m218-commit.sh
...
m223-test:
	bash scripts/m223-test.sh

m223-format:
	bash scripts/m223-format.sh

m223-benchmark:
	bash scripts/m223-benchmark.sh

m223-race:
	bash scripts/m223-race.sh

m223-vet:
	bash scripts/m223-vet.sh

m223-stage:
	bash scripts/m223-stage.sh

m223-commit:
	bash scripts/m223-commit.sh
...
m224-test:
	bash scripts/m224-test.sh

m224-format:
	bash scripts/m224-format.sh

m224-benchmark:
	bash scripts/m224-benchmark.sh

m224-race:
	bash scripts/m224-race.sh

m224-vet:
	bash scripts/m224-vet.sh


m224-stage:
	bash scripts/m224-stage.sh

m224-commit:
	bash scripts/m224-commit.sh
