...
bench-native-hattrie-lookup:
	NATIVE_HATTRIE_KEYS='$(NATIVE_HATTRIE_KEYS)' NATIVE_HATTRIE_LOOKUPS='$(NATIVE_HATTRIE_LOOKUPS)' NATIVE_HATTRIE_KEY_MODE='$(NATIVE_HATTRIE_KEY_MODE)' COUNT='$(COUNT)' BENCHMARK_ARTIFACT_DIR='$(BENCHMARK_ARTIFACT_DIR)' ./scripts/benchmark-native-hattrie-lookup.sh
