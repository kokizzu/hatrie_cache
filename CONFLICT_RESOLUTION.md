...
change the existing replication dispatcher. They do not perform quorum
acknowledgement or metadata consensus; callers must apply the selected version
atomically in their own storage path.
