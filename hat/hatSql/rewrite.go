...
func sqlRewriteFoldableFunction(name string) bool {
	switch name {
	case "LOWER", "COALESCE", "NULLIF", "VALID_AT", "PARSE_TIMESTAMP", "TIMESTAMP_ADD", "TIMESTAMP_DIFF", "REGEXP_LIKE", "REGEXP_EXTRACT", "JSON_VALUE", "JSON_QUERY", "JSON_EXISTS", "CONTAINS", "CONTAINS_PREFIX", "CONTAINS_PHRASE", "CONTAINS_PROXIMITY":
		return true
	default:
		return false
	}
