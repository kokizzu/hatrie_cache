...
func sqlGlobalStreamAggregates(query *sqlQuery) ([]sqlStreamAggregate, bool) {
	...
	for index, item := range query.selects {
		...
		case "AUTO_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT_STATE", "APPROX_COUNT_DISTINCT_MERGE", "APPROX_PERCENTILE", "APPROX_TDIGEST_PERCENTILE":
...
func sqlExprHasAggregate(expr sqlExpr) bool {
	...
	if expr.kind == "func" {
		switch expr.name {
		case "COUNT", "SUM", "AVG", "MIN", "MAX", "COUNT_OR_NULL", "SUM_OR_NULL", "AVG_OR_NULL", "MIN_OR_NULL", "MAX_OR_NULL", "ARGMAX", "ARGMIN", "AUTO_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT_STATE", "APPROX_COUNT_DISTINCT_MERGE", "APPROX_PERCENTILE", "APPROX_TDIGEST_PERCENTILE", "APPROX_TOP_K", "ARRAY_AGG", "GROUP_ARRAY", "GROUP_UNIQ_ARRAY", "MAP_AGG", "BITMAP_AGG", "COUNTIF", "COUNT_IF", "SUMIF", "SUM_IF", "AVGIF", "AVG_IF", "MINIF", "MIN_IF", "MAXIF", "MAX_IF", "ARGMAXIF", "ARGMAX_IF", "ARGMINIF", "ARGMIN_IF", "COUNT_STATE", "SUM_STATE", "AVG_STATE", "MIN_STATE", "MAX_STATE", "COUNT_MERGE", "SUM_MERGE", "AVG_MERGE", "MIN_MERGE", "MAX_MERGE", "ARGMAX_STATE", "ARGMIN_STATE", "ARGMAX_MERGE", "ARGMIN_MERGE":
			return true
		}
		for _, arg := range expr.args {
...
func evalSQLExpr(expr sqlExpr, group []sqlExecRow, row sqlExecRow) interface{} {
	...
	case "func":
		...
		case "AUTO_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT_STATE", "APPROX_COUNT_DISTINCT_MERGE", "APPROX_PERCENTILE", "APPROX_TDIGEST_PERCENTILE", "APPROX_TOP_K":
