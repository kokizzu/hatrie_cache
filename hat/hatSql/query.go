...
func sqlGlobalStreamAggregates(query *sqlQuery) ([]sqlStreamAggregate, bool) {
	...
	for index, item := range query.selects {
		...
		case "AUTO_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT", "APPROX_PERCENTILE", "APPROX_TDIGEST_PERCENTILE":
...
func evalSQLExpr(expr sqlExpr, group []sqlExecRow, row sqlExecRow) interface{} {
	...
	case "func":
		...
		case "AUTO_COUNT_DISTINCT", "APPROX_COUNT_DISTINCT", "APPROX_PERCENTILE", "APPROX_TDIGEST_PERCENTILE", "APPROX_TOP_K":
