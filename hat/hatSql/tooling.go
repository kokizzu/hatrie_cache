...
func sqlToolingKeyword(value string) bool {
	...
	case "SELECT", "FROM", "WHERE", "AS", "AND", "OR", "NOT", "IN", "IS", "NULL", "LIKE", "BETWEEN", "GROUP", "BY", "HAVING", "ORDER", "ASC", "DESC", "NULLS", "FIRST", "LAST", "LIMIT", "OFFSET", "JOIN", "INNER", "LEFT", "RIGHT", "FULL", "OUTER", "CROSS", "ON", "WITH", "RECURSIVE", "UNION", "INTERSECT", "EXCEPT", "ALL", "DISTINCT", "EXPLAIN", "PIPELINE", "COST", "ANALYZE", "CACHE", "KEYS", "VALUES", "TABLE", "EXTERNAL", "SAMPLE":
		return true
	default:
		return false
	}
