...
type SQLDataflowPlan = hatSql.SQLDataflowPlan
...
type SQLProjectionDiagnostics = hatSql.SQLProjectionDiagnostics
type SQLSourceSizeResolver = hatSql.SQLSourceSizeResolver
...
type SQLPrimaryPrefixRecommendation = hatSql.SQLPrimaryPrefixRecommendation
...
type SQLPartitionPredicate = hatSql.SQLPartitionPredicate
type SQLPartitionedSourceResolver = hatSql.PartitionedSourceResolver
type SQLPartitionPruningSourceResolver = hatSql.PartitionPruningSourceResolver
