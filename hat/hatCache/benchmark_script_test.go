...
func TestNativeHatTrieLookupBenchmarkMeasuresRepeatedBuildCPU(t *testing.T) {
	...
	data, err = os.ReadFile("hat/hatCache/luikore__hat-trie/test/bench_hattrie_lookup.c")
	if err != nil {
...
func TestCommandFeatureComparisonScriptJoinsBackendArtifacts(t *testing.T) {
	data, err := os.ReadFile("hat/hatCache/command_feature_benchmark_test.go")
	if err != nil {
...
func TestBigWinsBenchmarkHarnessCoversArchitecturalBottlenecks(t *testing.T) {
	...
	sourceData, err := os.ReadFile("hat/hatCache/big_wins_benchmark_test.go")
	if err != nil {
