...
func replicationPayloadKindFor(request CacheCommandRequest, response CacheCommandResponse) replicationPayloadKind {
	...
	switch command {
	case "DUMP", "GET", "GETSTR", "EXISTS", "TTL", "PEEKMAP", "HEADSLICE", "TAILSLICE", "HASSET", "GETSET", "PEEKPQ", "PEEKPRIORITY", "GETPQ", "GETPRIORITY", "HASBF", "BFHAS", "BFEXISTS", "INFOBF", "BFINFO", "HASCF", "CFHAS", "CFEXISTS", "INFOCF", "CFINFO", "HASRB", "RBHAS", "RBEXISTS", "COUNTRB", "RBCOUNT", "GETRB", "RBGET", "INFORB", "RBINFO", "ESTCMS", "QUERYCMS", "CMSQUERY", "CMSCOUNT", "INFOCMS", "CMSINFO", "COUNTHLL", "ESTHLL", "HLLCOUNT", "HLLCARD", "INFOHLL", "HLLINFO", "ESTTOPK", "QUERYTOPK", "TOPKCOUNT", "GETTOPK", "TOPK", "INFOTOPK", "TOPKINFO", "ESTQ", "QUERYQ", "QQUERY", "QSQUERY", "QUANTILE", "INFOQ", "QINFO", "INFOQS", "QSINFO", "GETFW", "FWGET", "SUMFW", "PREFIXFW", "FWPREFIX", "FWSUM", "RANGEFW", "FWRANGE", "INFOFW", "FWINFO", "INTERNALSET", "INTERNALDEL":
		return replicationPayloadNone
	case "DEL":
