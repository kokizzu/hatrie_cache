...
type CacheServiceClient interface {
	...
	GlobalTimestampReserve(ctx context.Context, in *GlobalTimestampReserveRequest, opts ...grpc.CallOption) (*GlobalTimestampReserveResponse, error)
...
func (c *cacheServiceClient) CommandBatchStream(ctx context.Context, opts ...grpc.CallOption) (CacheService_CommandBatchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CacheService_ServiceDesc.Streams[1], "/hatriecache.v1.CacheService/CommandBatchStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &cacheServiceCommandBatchStreamClient{stream}
	return x, nil
}

type CacheService_CommandBatchStreamClient interface {
	Send(*CommandBatchRequest) error
	Recv() (*CommandBatchResponse, error)
	grpc.ClientStream
}

type cacheServiceCommandBatchStreamClient struct {
	grpc.ClientStream
}

func (x *cacheServiceCommandBatchStreamClient) Send(m *CommandBatchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *cacheServiceCommandBatchStreamClient) Recv() (*CommandBatchResponse, error) {
	m := new(CommandBatchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *cacheServiceClient) ScalarBatchStream(ctx context.Context, opts ...grpc.CallOption) (CacheService_ScalarBatchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CacheService_ServiceDesc.Streams[2], "/hatriecache.v1.CacheService/ScalarBatchStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &cacheServiceScalarBatchStreamClient{stream}
	return x, nil
}

type CacheService_ScalarBatchStreamClient interface {
	Send(*ScalarBatchRequest) error
	Recv() (*ScalarBatchResponse, error)
	grpc.ClientStream
}

type cacheServiceScalarBatchStreamClient struct {
	grpc.ClientStream
}

func (x *cacheServiceScalarBatchStreamClient) Send(m *ScalarBatchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *cacheServiceScalarBatchStreamClient) Recv() (*ScalarBatchResponse, error) {
	m := new(ScalarBatchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *cacheServiceClient) GlobalTimestampReserve(ctx context.Context, in *GlobalTimestampReserveRequest, opts ...grpc.CallOption) (*GlobalTimestampReserveResponse, error) {
	out := new(GlobalTimestampReserveResponse)
	err := c.cc.Invoke(ctx, "/hatriecache.v1.CacheService/GlobalTimestampReserve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CacheServiceServer interface {
	...
	GlobalTimestampReserve(context.Context, *GlobalTimestampReserveRequest) (*GlobalTimestampReserveResponse, error)
...
func (UnimplementedCacheServiceServer) CommandBatchStream(CacheService_CommandBatchStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method CommandBatchStream not implemented")
}
...
func (UnimplementedCacheServiceServer) GlobalTimestampReserve(context.Context, *GlobalTimestampReserveRequest) (*GlobalTimestampReserveResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GlobalTimestampReserve not implemented")
}
...
func _CacheService_CommandBatchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CacheServiceServer).CommandBatchStream(&cacheServiceCommandBatchStreamServer{stream})
}

type CacheService_CommandBatchStreamServer interface {
	Send(*CommandBatchResponse) error
	Recv() (*CommandBatchRequest, error)
	grpc.ServerStream
}

type cacheServiceCommandBatchStreamServer struct {
	grpc.ServerStream
}

func (x *cacheServiceCommandBatchStreamServer) Send(m *CommandBatchResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *cacheServiceCommandBatchStreamServer) Recv() (*CommandBatchRequest, error) {
	m := new(CommandBatchRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _CacheService_ScalarBatchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CacheServiceServer).ScalarBatchStream(&cacheServiceScalarBatchStreamServer{stream})
}

type CacheService_ScalarBatchStreamServer interface {
	Send(*ScalarBatchResponse) error
	Recv() (*ScalarBatchRequest, error)
	grpc.ServerStream
}

type cacheServiceScalarBatchStreamServer struct {
	grpc.ServerStream
}

func (x *cacheServiceScalarBatchStreamServer) Send(m *ScalarBatchResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _CacheService_GlobalTimestampReserve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GlobalTimestampReserveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheServiceServer).GlobalTimestampReserve(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hatriecache.v1.CacheService/GlobalTimestampReserve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).GlobalTimestampReserve(ctx, req.(*GlobalTimestampReserveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CacheService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GlobalTimestampReserve",
			Handler:    _CacheService_GlobalTimestampReserve_Handler,
		},
		{
			MethodName: "Topology",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CommandBatchStream",
			Handler:       _CacheService_CommandBatchStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
