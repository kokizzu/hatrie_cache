...
| Current pass | Public Bloom-filter core extraction, direct byte add/lookup and fixed DUMP reuse | Root callback loop: 39.97/54.24 ns add/lookup; fixed DUMP 6,323 ns | Public direct-loop core: 30.96/43.09 ns add/lookup; fixed DUMP 6,216 ns | Add 1.29x faster; lookup 1.26x faster; DUMP 1.02x faster | All paths remain 0 B/op and 0 allocs/op; fixed DUMP remains 58,932 wire B; generic JSON coercion stays in the cache adapter |
