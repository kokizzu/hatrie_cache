...
while staged XOR filters keep JSON fallback for pending values. Existing JSON
records still load automatically.
...
JSON fallback. The gzip-best-binary snapshot default uses about 18% fewer
