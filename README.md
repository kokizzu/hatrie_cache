...
- Opt-in retractable, binary-serializable, and snapshot-transactional SQL aggregate capabilities: [MU031_RETRACTABLE_AGGREGATES.md](MU031_RETRACTABLE_AGGREGATES.md), with measurements in [BENCHMARK.md](BENCHMARK.md#mu-031-retractable-aggregate-capabilities)
...
- Tarantool-inspired opt-in redacted conflict introspection stream: [TU038_CONFLICT_INTROSPECTION.md](TU038_CONFLICT_INTROSPECTION.md)
