...
- Tarantool-inspired snapshot-plus-WAL join bootstrap with bounded resume checkpoints and fencing validation: [TU09_SNAPSHOT_JOIN_BOOTSTRAP.md](TU09_SNAPSHOT_JOIN_BOOTSTRAP.md), with measurements in [BENCHMARK.md](BENCHMARK.md#tu-09-snapshot-plus-wal-join-bootstrap)
