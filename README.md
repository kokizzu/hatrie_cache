...
- Opt-in per-space WAL sync policies wired into `hatCache.CommandJournal`, with periodic, immediate, and disabled modes: [TU34_SPACE_WAL_SYNC_POLICY.md](TU34_SPACE_WAL_SYNC_POLICY.md), with raw before/after measurements in [BENCHMARK.md](BENCHMARK.md#t-u34-per-space-wal-sync-policy)
