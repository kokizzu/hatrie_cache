...
| M-U09 | Explicit lower/upper frontier API | Differential timestamps exist, but external consumers cannot observe a complete per-object lower/upper frontier contract. | Monotonicity, progress records, and no false completion. |
